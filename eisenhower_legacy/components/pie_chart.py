...
class PieChart(BaseComponent):
    ...
    def update(self, task_manager):
        """파이 차트 업데이트"""
        self.available_hours = task_manager.available_hours
        self.available_minutes_part = task_manager.available_minutes_part
        ...
        # 파이 차트 데이터 준비
        sizes = [task.assigned_time for task in task_manager.tasks]
